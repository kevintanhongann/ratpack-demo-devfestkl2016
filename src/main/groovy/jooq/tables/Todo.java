...
public class Todo extends TableImpl<TodoRecord> {
    ...
    private static final long serialVersionUID = -1191420319;
     ...
     */
    public final TableField<TodoRecord, Long> ID = createField("ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("(NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_6E07F84A_84F5_4560_A29C_65B43D15CE15)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
